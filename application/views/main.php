    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-15px">
                        <img src="<?=base_url()?>public/images/logo_black.png" alt="logo" class="img-responsive" width="150px">
                    </a>
                </div>
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Copyright <a  target="_blank" href="https://www.facebook.com/madhawa.dias">Madhawa Dias</a>
            </p>
        </footer>
